...
lint-py:  ## run python linter with ruff
	python -m ruff check fsspec_browser
	python -m ruff format --check fsspec_browser
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix fsspec_browser
	python -m ruff format fsspec_browser
...
test-py:  ## run python tests
	python -m pytest -v fsspec_browser/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v fsspec_browser/tests --cov=fsspec_browser --cov-report term-missing --cov-report xml
